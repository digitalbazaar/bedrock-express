  ...
  async.auto({
    ...
    session: ['beforeSession', function(callback, results) {
      ...
      if(bedrock.config.express.useSession) {
        server.use(express.session(bedrock.config.express.session));
      }
      callback();
    }],
    ...
    unhandledErrorHandler: [
      ...
      server.use(express.errorHandler({
        dumpExceptions: bedrock.config.express.dumpExceptions,
        showStack: bedrock.config.express.showStack
      }));
      callback();
    }],
